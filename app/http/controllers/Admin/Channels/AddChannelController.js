...
const AddChannelService = require("../../../../services/Admin/Channels/AddChannelService");

const addChannel = async (req, res) => {
  const { body, session } = req;
  const rules = AddChannelService.rules;
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:addChannel()`,
      },
      req.log
    );
  }
