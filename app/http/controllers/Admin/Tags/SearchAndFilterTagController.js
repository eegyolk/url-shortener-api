...
const SearchAndFilterTagService = require("../../../../services/Admin/Tags/SearchAndFilterTagService");

const searchTag = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterTagService.rules;
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:searchTag()`,
      },
      req.log
    );
  }
...
const filterTag = async (req, res) => {
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:filterTag()`,
      },
      req.log
    );
  }
