...
const SearchAndFilterUTMParameterService = require("../../../../services/Admin/UTM/SearchAndFilterUTMParameterService");

const searchUTMParameter = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterUTMParameterService.rules;
...
const filterUTMParameter = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterUTMParameterService.rules;
