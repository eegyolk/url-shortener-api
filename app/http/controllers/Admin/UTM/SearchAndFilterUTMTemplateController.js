...
const SearchAndFilterUTMTemplateService = require("../../../../services/Admin/UTM/SearchAndFilterUTMTemplateService");

const searchUTMTemplate = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterUTMTemplateService.rules;
...
const filterUTMTemplate = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterUTMTemplateService.rules;
