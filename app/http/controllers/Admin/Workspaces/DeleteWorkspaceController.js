...
const DeleteWorkspaceService = require("../../../../services/Admin/Workspaces/DeleteWorkspaceService");

const deleteWorkspace = async (req, res) => {
  const { body, session } = req;
  const rules = DeleteWorkspaceService.rules;
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:deleteWorkspace()`,
      },
      req.log
    );
  }
