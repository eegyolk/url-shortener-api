...
const SearchAndFilterMemberService = require("../../../../services/Admin/Workspaces/SearchAndFilterMemberService");

const searchMember = async (req, res) => {
  const { body, session } = req;
  const rules = SearchAndFilterMemberService.rules;
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:searchMember()`,
      },
      req.log
    );
  }
...
const filterMember = async (req, res) => {
  ...
  try {
    ...
    Logger.log(
      ...
      {
        err,
        msg: `Error occurred in ${path.basename(__filename)}:filterMember()`,
      },
      req.log
    );
  }
